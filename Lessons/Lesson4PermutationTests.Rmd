...
Use bigger data set where exhaustive permutation would be prohibitive. Try testing if the price of a high end home (at the 80th percentile) is higher for homes with or without swimming pools. Use the Ames homes data
